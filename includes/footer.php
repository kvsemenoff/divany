	...
	<div class="container">
		<div class="row">
			<div class="db-footer-icon-container">
				<div class="db-footer-icon-one"><a href="#"><img src="img/db-footer-1.png" alt="img"></a></div>
				<div class="db-footer-icon-two"><a href="#"><img src="img/db-footer-2.png" alt="img"></a></div>
				<div class="db-footer-icon-three"><a href="#"><img src="img/db-footer-3.png" alt="img"></a></div>
			</div>
			<div class="col-md-12">
